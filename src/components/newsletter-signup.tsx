...
// Kit (ConvertKit) form ID. Create a form in Kit (kit.com → Grow → Landing Pages
// & Forms), then copy the numeric form ID from its embed/share URL and paste it
// here. Until then this component renders nothing.
const KIT_FORM_ID = "YOUR_FORM_ID"
const newsletterEnabled = KIT_FORM_ID !== "YOUR_FORM_ID"
