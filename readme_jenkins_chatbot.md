name:	avisangle/jenkins-chatbot-plugin
description:	A Jenkins plugin that provides an intelligent conversational interface for Jenkins operations. Chat with AI to manage builds, deployments, and system operations through natural language, all while respecting your Jenkins permissions.
--
# Jenkins AI Chatbot
